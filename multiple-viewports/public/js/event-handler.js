...
function clickSubmitEventListener(event) {
  ...
  try {
    fileNameNew =
      "/models/obj/" + document.getElementById("file").files[0].name;
  } catch (err) {
...
function initEventHandler(event) {
  ...
  document
    ...
    .addEventListener("click", clickSubmitEventListener, false);
  document
  ...
  // Radio Buttons
  document
    .getElementById("radio-points")
    .addEventListener("input", inputRadioPointsEventListener, false);
  document
    .getElementById("radio-wireframe")
    .addEventListener("input", inputRadioWireframeEventListener, false);
  document
    .getElementById("radio-solid")
    .addEventListener("input", inputRadioSolidEventListener, false);
